...
#define CYBLE_SENSOR_SERVICE_INDEX   (0x00u) /* Index of Sensor service in the cyBle_customs array */
#define CYBLE_SENSOR_ANALOG_CHAR_INDEX   (0x00u) /* Index of Analog characteristic */
#define CYBLE_SENSOR_ANALOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_SENSOR_ANALOG_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Server Characteristic Configuration descriptor */


#define CYBLE_SENSOR_SERVICE_HANDLE   (0x0010u) /* Handle of Sensor service */
#define CYBLE_SENSOR_ANALOG_DECL_HANDLE   (0x0011u) /* Handle of Analog characteristic declaration */
#define CYBLE_SENSOR_ANALOG_CHAR_HANDLE   (0x0012u) /* Handle of Analog characteristic */
#define CYBLE_SENSOR_ANALOG_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_SENSOR_ANALOG_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Server Characteristic Configuration descriptor */
