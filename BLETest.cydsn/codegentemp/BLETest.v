// ======================================================================
// BLETest.v generated from TopDesign.cysch
// 11/28/2018 at 14:50
...
module SCB_P4_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("45945a2b-d4dc-48b8-bf41-268492ea2dcd/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45945a2b-d4dc-48b8-bf41-268492ea2dcd/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45945a2b-d4dc-48b8-bf41-268492ea2dcd/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("8269a754-17eb-4756-aa61-80ba1143e645/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("93750375.0015"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
module top ;
	...
	wire [0:0] tmpOE__Sig_Input_net;
	wire [0:0] tmpFB_0__Sig_Input_net;
	wire [0:0] tmpIO_0__Sig_Input_net;
	wire [0:0] tmpINTERRUPT_0__Sig_Input_net;
	electrical [0:0] tmpSIOVREF__Sig_Input_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Sig_Input
		 (.oe(tmpOE__Sig_Input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sig_Input_net[0:0]}),
		  .analog({Net_4198}),
		  .io({tmpIO_0__Sig_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__Sig_Input_net),
		  .interrupt({tmpINTERRUPT_0__Sig_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sig_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
